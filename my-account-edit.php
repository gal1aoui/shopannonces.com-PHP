...
if($action=='change'){
	@extract(post);
	$user_id = @$_REQUEST['mem_email'];
	
	$comp_name = secureValue(@$_REQUEST['comp_name']);
	$comp_address = secureValue(@$_REQUEST['comp_address']);
	$comp_city = secureValue(@$_REQUEST['comp_city']);
	$comp_state = secureValue(@$_REQUEST['comp_state']);
	$comp_postal = secureValue(@$_REQUEST['comp_postal']);
	$comp_country = secureValue(@$_REQUEST['comp_country']);
	$comp_website = secureValue(@$_REQUEST['comp_website']);
	$mem_fname = secureValue(@$_REQUEST['mem_fname']);
	$mem_lname = secureValue(@$_REQUEST['mem_lname']);
	$mem_email = secureValue(@$_REQUEST['mem_email']);
	$mem_address = secureValue(@$_REQUEST['mem_address']);
	$mem_postal = secureValue(@$_REQUEST['mem_postal']);
	$mem_city = secureValue(@$_REQUEST['mem_city']);
	$mem_state = secureValue(@$_REQUEST['mem_state']);
	$mem_country = secureValue(@$_REQUEST['mem_country']);
	$mem_telno = secureValue(@$_REQUEST['mem_telno']);
	$alter_id = secureValue(@$_REQUEST['alter_id']);
	
	
	$sql="Update `tbl_member` SET 
	`comp_name` = '$comp_name',`comp_address` = '$comp_address',`comp_city` = '$comp_city',	`comp_province` = '$comp_state',`comp_postalcode` = '$comp_postal',`comp_country` = '$comp_country', `comp_url` = '$comp_website',
	`user_id` = '$user_id',`fname` = '$mem_fname',`lname` = '$mem_lname', `type`='$user_type', `email` = '$mem_email',
	`address` = '$mem_address',`post_code` = '$mem_postal',`city` = '$mem_city',
	`state` = '$mem_state',`country` = '$mem_country',	`tel_no` = '$mem_telno',`class_alerts`='$alert_id'
	 WHERE mem_id='$_COOKIE[memId]'";
...
<div class="grid_13" style="background-color:#FFFFFF">
    ...
    <div class="p7">        
        <div class="panel panel-default">
          ...
          <div class="panel-heading"><div class="main-heading">Mes Informations</div></div>
          <div class="panel-body">
                <form name="frm" method="post" action="">
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td><input name="old_pwd" id="old_pwd" type="password" class="textbox" /></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td><input name="new_pwd" type="password" class="textbox"  /></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td><input name="c_pwd" type="password" class="textbox" /></td>
                            <td>
                ...
                <?php
                $sql="select * from tbl_member where mem_id='".$_COOKIE[memId]."'";
                $rw=db_query($sql);
                ...
                <form name="form1" method="post" action="">    
                    <table width="100%">
                        ...
                        <tr class="bg-stripcolor">
                            ...
                            <td>
                                <input name="mem_email" type="text" class="textbox" id="mem_email" value="<?php echo $res[user_id]?>" required="required" />
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="radio" name="user_type" value="Particulier" <?php if($res[type]=="Particulier") echo "checked";?> />Particulier
                                <input type="radio" name="user_type" value="Professionnel" <?php if($res[type]=="Professionnel") echo "checked";?> />Professionnel
                             </td>
                            <td>&nbsp;</td>
                        </tr>
                        ...
                        <tr>
                            <td>Pays :</td>
                            <td>             
                                <select name="mem_country" id="select" size="1" class="textbox" >
