...
if(!empty($tmpClsID)){
	if(isset($_COOKIE['memId']) && $_COOKIE['memId']!=""){
		...
		from tbl_classified where classified_id=$tmpClsID and classified_status!='Delete' and mem_id='".$_COOKIE['memId']."'";
	}else{
		$sql_clsi_show="select *,DATE_FORMAT(classified_post_date ,'%d-%m-%Y') as cli_post_date
...
if(mysql_num_rows($sql_rs_set)!=0)
{
        ...
        <div class="panel-body">                
            ...
            <div class="" style="color: gray;">
                Publiée le <strong style="color:#000000;"><?php echo $res[cli_post_date];?></strong> 
                            ...
                            par <strong style="color:#000000;"><?php echo getMemberFullName($res[mem_id]);?> &nbsp; <span style="color: #808080; font-size: xx-small;">Certifi&eacute; en France</span>&nbsp;</strong><img src="http://fl.medirect.top/cetrifi&eacute;_france.jpg" alt="" /></p>
...
?>
		...
		<div class=" mt20">
			<table width="100%" border="0" cellspacing="2" cellpadding="2">
                        ...
                        <tr>
                            <td>
                                <table width="100%" border="0" cellspacing="0" cellpadding="4" class="cate-border p7">
...
<div class="grid_5 tc" style="padding-top:100px;">
    ...
    <div>
        <a href="" rel="facebox" class="link-signaler" 
    ...
    <div style="font-weight: bold;font-size: 11px;">
                    <a href="#"  onClick="window.print();"
                        style="color: #626364;text-decoration: none;border: 0;">
    ...
    <div>
		<span class="heading">Visite: <?php echo $visites=classified_visits($tmpClsID); ?></span>
	</div>
