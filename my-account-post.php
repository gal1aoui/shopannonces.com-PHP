...
<div class="grid_13" style="background-color:#FFFFFF; min-height:600px;">
            ...
            <table width="100%" cellpadding="5" cellspacing="0" >
                ...
                <tr class="bg-stripcolor">
                  ...
                  <div id="filestore">
                    ...
                    <input name="file[]" id="file5" type="file" class="textbox1" size="44" onChange="readURL(this,blah5);" /><br />
                    <input name="file[]" id="file6" type="file" class="textbox1" size="44" onChange="readURL(this,blah6);" /><br />
                    <input name="file[]" id="file7" type="file" class="textbox1" size="44" onChange="readURL(this,blah7);" /><br />
                    <input name="file[]" id="file8" type="file" class="textbox1" size="44" onChange="readURL(this,blah8);" /><br />
                    </div>
                  </td>
                </tr>
                <tr class="bg-stripcolor">
                  <td colspan="2" align="center">
                    <table cellspacing="2">
                        <tr>
                            ...
                            <td><img name="blah3" id="blah3"></td>
                            <td><img name="blah4" id="blah4" ></td>
                       
                            <td><img name="blah5" id="blah5"></td>
                            <td><img name="blah6" id="blah6"></td>
                       
                            <td><img name="blah7" id="blah7"></td>
                            <td><img name="blah8" id="blah8" ></td>
                        </tr>
                    </table>
    ...
    <p>
        ...
        Avec Shopannonces site d'annonces gratuites en France déposez votre petite annonce gratuitement. Publier son annonce de bien ou de service et passer une annonce partout en france sans aucun frais. Publiez une petite annonce immo gratuite ? Vendre sa voiture ? Vendre un appartement ou vendre une maison neuve ou ancienne ? Shopannonces propose une service de particulier a particulier 100% gratuit. Passer une annonce immobiliere gratuite ou mettre une annonce d'occasion c'est simple rapide et efficace sur Shopaannonces. Retrouvez toutes nos annonce facilement: vendre sa maison | vendre son appartement | vendre voiture| vendre moto| vendre mobile| louer une maison | louer appartement | services aux particuliers.
        </span>
    </p>
