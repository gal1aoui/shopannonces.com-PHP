...
<div class="grid_16">
    <label class="titre">Paiement 100% sécurisé (via StarPass) <img src="mobile/images/cadenat.png" width="16" height="16" /></label>
</div>
...
<div class="grid_11">
    <div id="starpass_253107"></div><script type="text/javascript" src="http://script.starpass.fr/script.php?idd=253107&amp;datas=<?=$recordId?>"></script><noscript>Veuillez activer le Javascript de votre navigateur s'il vous pla&icirc;t.<br /><a href="http://www.starpass.fr/">Micropaiement StarPass</a></noscript>
