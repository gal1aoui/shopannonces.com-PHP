...
<form name="frm" action="classified-listing.php" method="get">

<div class="green-bgcolor white-style b" style="border-radius: 3px 3px 0 0; padding:5px; border-width:2px; border-style: solid;">
	...
	<div class="">
        ...
        <select name="cat" onChange="cat_drop_down_search(this.value,'')" class="textbox" style="width:auto;">
    ...
    <input type="radio" name="offer_type" value="Je offre" <?php if($_REQUEST[offer_type]=="Je offre") echo "checked='checked'"; ?> />Offre 
    <input type="radio" name="offer_type" value="Je cherche" <?php if($_REQUEST[offer_type]=="Je cherche") echo "checked='checked'"; ?> />Cherche
    
    <input type="checkbox" name="picture"  <?php if($_REQUEST[picture]=="on") echo "checked='checked'"; ?> />Avec photo
...
.results th.headerSortUp {background:  url('images/asc.gif') no-repeat 100% 50%;}
.results th.headerSortUp:hover {background: url('images/asc.gif') no-repeat 100% 50%;}

.results th.headerSortDown {background:  url('images/desc.gif') no-repeat 100% 50%;}
.results th.headerSortDown:hover {background: url('images/desc.gif') no-repeat 100% 50%;}
