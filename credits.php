...
<div class="grid_13" style="background-color:#FFFFFF">
    ...
    <div class="tab-content">
      ...
      <div role="tabpanel" class="tab-pane active" id="allopass">
      	...
      	<iframe width="550" height="480" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" src="https://payment.allopass.com/buy/buy.apu?ids=324098&idd=1418438"></iframe>
      ...
      <p>
        ...
        <p>
        c'est rapide et facile. Il suffit de remplir les noms, prénoms et adresses e-mails de vos amis. Quand l'un d'entre eux passera au moins 1 annonce, vous recevez 1 &euro; de crédit consommable sur mesannonces.site
      </p>
      </div>
      -->
    </div>
