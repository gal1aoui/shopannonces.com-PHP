    ...
    $img_name[]=$res1[cls_img_file];
	  $autoID[]=$res1['clsd_img_id']; 	   
	   if($res1[cls_img_file]!="" && file_exists($file_sm)){
         $link[]= '<img src="../uploaded_files/classified_img/'.$res1[cls_img_file].'" width=100 height=100" border="1"/>';
         $lien[]= '../uploaded_files/classified_img/'.$res1[cls_img_file];
...
?>
           ...
           <form action="save_mod_details.php" method="post">
                <tr valign="top" class="border_bot">
                ...
                <tr valign="top" class="border_bot">
                  ...
                  <td align="left" class="border_bot">
                  	<input type="text" name="classi_fax" value="<?php echo $res[classi_fax];?>"></td>
                </tr>
                <tr valign="top" class="border_bot">
                  <td width="50%" align="right" class="border_bot">  Address : </td>
                  <td width="50%" align="left" class="border_bot"><?php echo $res[classified_poster_street];?></td>
                </tr>
                <tr valign="top" class="border_bot">
                ...
                <td align="left" class="border_bot"><?php
				$var="";				
                ...
                <tr valign="top" class="border_bot">
                  <td align="right" class="border_bot"> Classified Title 

: </td>
                  <td align="left" class="border_bot"><?php echo $res['classified_title'];?></td>
                </tr>
                <tr valign="top" class="border_bot">
				...
				<?php if(count($link) > 0 ) { ?>
                <tr align="left" valign="top" class="border_bot">
                  <td align="left"><strong>View Pictures :</strong></td>
                  <td>&nbsp;</td>
                </tr>
<?php 
