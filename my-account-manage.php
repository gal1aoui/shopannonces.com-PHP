...
where mem_id ='$_COOKIE[memId]' and classified_status!='Delete' order by classified_id desc,cli_post_date  limit $start, $pagesize ";
...
if(isset($_REQUEST[act]) && $_REQUEST[act]!="")
{
	...
	$condition="where classified_id=$clsID and mem_id ='$_COOKIE[memId]' ";
...
<div class="grid_13" style="background-color:#FFFFFF">
    ...
    <div class="p7">        
        <div class="panel panel-default">
            ...
            <div class="panel-heading"><div class="main-heading">Mes Annonces</div></div>
                    ...
                    <div class="p7">
                        <table width="100%" class="table table-striped">
                                <tr class="">
                                    ...
                                    <th width="200px">Options disponibles</th>
                                </tr>
                            ...
                            while($rw=mysql_fetch_array($rs_classi)){ 
                                ...
                                <tr class="b"  bgcolor="<?php echo $AnnonceCouleur;?>" style="border-bottom:#666 solid 1px;">
                                    ...
                                    <td>
                                        <p>
                                            <a href="classified-option.php?clsId=<?php echo $rw[classified_id];?>&date_fin_premium=y" class="link2" >
                                                <b>Annonce Premium</b>
                                            </a>
                                            &nbsp;
                                        ...
                                        <p>
                                            <a href="classified-option.php?clsId=<?php echo $rw[classified_id];?>&date_fin_couleur=y" class="link2" >
                                        ...
                                        <p>
                                            <a href="classified-option.php?clsId=<?php echo $rw[classified_id];?>&date_fin_republication=y" class="link2" >
                                        ...
                                        <p>
                                            <a href="classified-option.php?clsId=<?php echo $rw[classified_id];?>&date_fin_urgent=y" class="link2" >
                                                <b>Option Urgent</b>
                                            </a>
                                            &nbsp;
