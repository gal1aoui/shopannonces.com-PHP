	...
	if(empty($name) || empty($email) || empty($org) || empty($contact_no) || empty($cat_level_root) || empty($ban_position) || empty($urls) || empty($comments)) {
	 ...
	 ################# Upload  image ################
		...
		if($fileName!='' && $NotVail_files){	 
			...
			$destLoc = 'uploaded_files/advertise/'.$destFile;
			...
			<div class="mt17">
            	...
            	<form action="advertise.php" method="post" enctype="multipart/form-data" >
                  ...
                  <tr>
                    ...
                    <td width="66%" align="left"><input name="name" type="text" class="textbox1" id="name"  style="width:300px;" required="required"/></td>
                  </tr>
                  <tr class="bg-stripcolor">
                    <td width="34%" align="right"> <span class="star">*</span> Email ID: </td>
                    <td width="66%" align="left"><input name="email" type="text" class="textbox1" id="email"  style="width:300px;" required="required"/></td>
                  </tr>
                  <tr>
                    <td width="34%" align="right"><span class="star">*</span> Nom de compagnie : </td>
                    <td width="66%" align="left"><input name="org" type="text" class="textbox1" id="org"  style="width:300px;" required="required"/></td>
                  </tr>
                  <tr class="bg-stripcolor" >
                    <td align="right"><span class="star">*</span> No Tél: : </td>
                    <td align="left"><input name="contact_no" type="text" class="textbox1" id="contact_no"  style="width:300px;"  required="required"/></td>
                  </tr>
                  <tr>
                  <?php
                    $cat_level_root = secureValue($cat_level_root);
                  ...
                  ?>	  
                    ...
                    <td align="left">
                     <select name="cat_level_root" class="textbox1" style="width:308px;" onChange="cat_drop_down_advertise(this.value,'')" required>
                    ...
                    <td align="left"><div id="cat_tree1">				 
                          <select name='cat_level_one' class='textbox1' style='width:308px;' onChange="cat_drop_down2_advertise(this.value,'')" />				 			  
                          </select>
                           </div>				  
                  ...
                  <tr>
                    ...
                    <td align="left">
                    <div id="cat_tree2">
                          <select name="cat_level_two" class="textbox1" style="width:308px;">
                          </select>
                  </div>		  </td>
                  </tr>
                  <tr>
                    ...
                    <td align="left">
                    <select name="ban_position" class="textbox1" id="ban_position" style="width:308px;"  required="required">
                  ...
                  <tr>
                    ...
                    <td align="left"><input name="urls" type="text" class="textbox1" id="urls"  style="width:300px;"  required="required"/> 
                      Ex: http://www.abc.com/</td>
                  </tr>
                  <tr valign="top" class="bg-stripcolor" >
                    <td align="right"> <span class="star">*</span> Commentaires : </td>
                    <td align="left"><textarea name="comments"  rows="4" class="textbox1" id="comments" style="width:300px;"  required="required"></textarea></td>
                  </tr>
                  <tr valign="top" >
                    <td align="right" >&nbsp;</td>
                    <td align="left">
