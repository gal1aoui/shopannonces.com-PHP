...
if(!empty($tmpReference)){
	...
	if($mode=="html"){
		...
		if(isset($_SESSION['signin']['mem_id']) && $_SESSION['signin']['mem_id']!=""){
			...
			$sql_bill_show = "SELECT * , DATE_FORMAT( facture_date,  '%d/%m/%Y' ) AS post_date
								...
								WHERE 
									tbl_classified.mem_id =  '".$_SESSION['signin']['mem_id']."' 
	...
	?>
                    ...
                    <div class="p7">  
                        <div class="panel panel-default">
                          ...
                          <div class="panel-heading">
                            <img src="uploaded_files/logo/logo.png" />
                          </div>
                          <div class="panel-body">
                              ...
                              <br />
                              <p>
                                Email : contact@flyannonces.com - web : www.flyannonces.com
                              </p>
		...
		readfile("uploaded_files/factures/".$tmpReference.".pdf");
