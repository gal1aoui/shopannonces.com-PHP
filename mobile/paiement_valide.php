...
@mail("adnene_braham@hotmail.fr",'paiement mobile option fr','annonce '.$clsId.', code '.$codeDoc);
$option_paiee=array();
$total_paiee=array();
?>
<noscript><meta http-equiv="refresh" content="0;url=http://script.starpass.fr/error_code2.php?idd=<?php echo $codeDoc;?>&idp=69875"></noscript><script type="text/javascript" src="http://script.starpass.fr/error_code.php?idd=<?php echo $codeDoc;?>&idp=69875"></script>
<body>
<?php
