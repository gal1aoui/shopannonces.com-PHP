...
$strcat="select clsd_cat_id from tbl_classified where classified_id ='$clsID'";
$resultcat=mysql_query($strcat) or die(mysql_error());
$rowcat=mysql_fetch_array($resultcat);
$strg="select * from tbl_social_network where cat_id='$rowcat[clsd_cat_id]' and status='Y' order by rand() limit 4";
...
<table width="100%" border="0" cellspacing="0" cellpadding="3" class="mt17">
        ...
        <tr>
		  ...
		  <div class="border-bot">
		   <?php echo $rowg[social_network_ads]?> 
		    </div>
		  <?php
		  }
		  ?>        
