...
if(is_post_back()) {
	...
	if(is_array($arr_pd_ids)){	
		...
		if(isset($_REQUEST['Delete']) || isset($_REQUEST['Delete_x']) ) {
			$sql = "delete from tbl_manage_google_ads where id in ($str_pd_ids)";
			db_query($sql);
			$_SESSION['site_admin_message']="Ads deleted Successfully.........";
		} else if(isset($_REQUEST['Activate']) || isset($_REQUEST['Activate_x']) ) {
			$sql = "update tbl_manage_google_ads set status = 'Y' where id in ($str_pd_ids)";
			db_query($sql);			
			$_SESSION['site_admin_message']="Ads Activated Successfully.........";
		} else if(isset($_REQUEST['Deactivate']) || isset($_REQUEST['Deactivate_x']) ) {
			 $sql = "update tbl_manage_google_ads  set status = 'N' where id in ($str_pd_ids)";
			db_query($sql);
...
$columns = "select * ";
$sql = " from tbl_manage_google_ads  ";
$sql .= "where 1 ";
$sql = apply_filter($sql, @$pd_name, @$u_name_filter,'pd_name');
@$order_by == '' ? $order_by = 'tbl_manage_google_ads.id' : true;
...
?>
<?php echo PageTitle('Google Ads Management');?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>	  
		...
		<div align="right" > <br>
		<a href="land.php?file=add_google_ads"><b>Add New Ads </b></a>
		<br><br>
		</div>
      ...
      <form method="post" name="form1" id="form1" onSubmit="confirm_submit(this)">
        <table width="100%"  border="0" cellpadding="0" cellspacing="1" class="tableList">
          ...
          <tr class="<?php echo $css?>">
				        ...
				        <td align="center">
						<a href="?file=edit_google_adg&id=<?php echo $id?>"><img src="images/icons/edit.png" alt="Edit" width="16" height="16" border="0" /></a></td> 
