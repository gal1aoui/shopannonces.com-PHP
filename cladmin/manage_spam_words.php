...
if(is_post_back()) {
	...
	if(is_array($arr_pd_ids)){	
		...
		if(isset($_REQUEST['Delete']) || isset($_REQUEST['Delete_x']) ) {
			$sql = "delete from ".DB.".tbl_spam_words where sp_id in ($str_pd_ids)";
			db_query($sql);
			$_SESSION['site_admin_message']="Spam Word deleted Successfully.........";
		} else if(isset($_REQUEST['Activate']) || isset($_REQUEST['Activate_x']) ) {
			$sql = "update ".DB.".tbl_spam_words set status = 'Y' where sp_id in ($str_pd_ids)";
			db_query($sql);			
			$_SESSION['site_admin_message']="Spam Word Activated Successfully.........";
		} else if(isset($_REQUEST['Deactivate']) || isset($_REQUEST['Deactivate_x']) ) {
			 $sql = "update ".DB.".tbl_spam_words  set status = 'N' where sp_id in ($str_pd_ids)";
			db_query($sql);
			$_SESSION['site_admin_message']="Spam Word Deactivate Successfully.........";
		}		
	 }	 
} 
$start = intval($start);
...
$columns = "select * ";
$sql = " from ".DB.".tbl_spam_words  ";
$sql .= "where 1 ";
$sql = apply_filter($sql, $pd_name, $u_name_filter,'pd_name');
$order_by == '' ? $order_by = DB.'.tbl_spam_words.sp_id' : true;
...
?>
<?php echo PageTitle('Spam Management');?>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>	  
     </b>
		<div align="right" > <br>
		<a href="land.php?file=add_edit_spam_words"><b>Add New Word </b></a>
		<br><br>
		</div>
      ...
      <form method="post" name="form1" id="form1" onSubmit="confirm_submit(this)">
        <table width="100%"  border="0" cellpadding="0" cellspacing="1" class="tableList">
          <tr>
             <th width="46%" align="left" >Words</th>
             <th width="30%" align="right">Status</th>
          ...
          <tr class="<?php echo $css?>">
                         <td align="left"><?php echo $words;?></td>
						 <td align="right"><?php echo $rec_status;?></td>
				        <td align="center">
						<a href="?file=add_edit_spam_words&sp_id=<?php echo $sp_id?>"><img src="images/icons/edit.png" alt="Edit" width="16" height="16" border="0" /></a></td> 
						
						<td align="center">
						<input name="arr_pd_ids[]" type="checkbox" id="arr_pd_ids[]" value="<?php echo $sp_id?>" /></td>
          </tr>
          <?php $k++; }?>
        </table>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
