...
.bouton_rouge
{
 ...
 <ul id="nav">
                <?php
                                    ...
                                    $sel="";
                                    ?>
                    <li <?php echo $sel;?>><a href="news.php"><b>A la une</b></a></li>
                            <?php
                ...
                <tr>
                    <td align="center">
                        <table border="0">
                                ...
                                $sql_cat=db_query("select *, LEFT(`contenu_news`,500) AS description_news from news $sel ORDER BY date_news DESC, order_news ASC");
                                                ...
                                                <tr>
                                                    <td>
                                                            <a href="contenu_news.php?news_id=<?php echo $rw[news_id];?>" class="link1">
                                                                ...
                                                                if($nbre_image>0){
                                                                    ...
                                                                    width='450' height='<?php echo $height;?>' style="border-color:#ffffff; border-style:solid; border-radius:5px;"  />
                                                    ...
                                                    ?>
                                                        <div style="padding:3px; padding-left:6px; 
                                                                    ...
                                                                    font-style:italic; width:250px; height:<?php echo $height;?>px;">
