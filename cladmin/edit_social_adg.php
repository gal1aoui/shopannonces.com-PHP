...
if($action=='Add'){
 @extract($_POST);
 $ins=db_query("update ".DB.".tbl_social_network  set title='$title',cat_id='$category',social_network_ads='$ads' where id='$id'");
 $_SESSION['site_admin_message']="Ads Updated Successfully.........";
/* header("Location:land.php?file=social_network_ads");
 exit();*/
}

$selfaq=db_query("select * from ".DB.".tbl_social_network   where id='$id'");
$rw=mysql_fetch_array($selfaq);
?>
<?php echo PageTitle('Edit Google Ads');?>
...
<form name="form1" method="post" enctype="multipart/form-data" onSubmit="return validate();">
  <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tableForm">
    ...
    <tr>
      ...
      <td width="575" align="left" class="tdData"><textarea name="ads" cols="70" rows="10"><?php echo $rw[social_network_ads];?></textarea></td>
    </tr>
    <tr>
      <td class="tdLabel">&nbsp;</td>
