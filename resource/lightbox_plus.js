...
LightBox.prototype = {
	...
	_set_photo_size : function()
	{
		...
		if (self._prev && self._next)
		{
			...
			self._prev.style.cursor  = 'pointer';
			self._next.style.cursor  = 'pointer';
		}
	},
...
Event.register(window,"load",function() {
	var lightbox = new LightBox({
		loadingimg:site_ws_path+"/resource/loading.gif",
		expandimg:site_ws_path+"/resource/spacer.gif",
		shrinkimg:site_ws_path+"/resource/spacer.gif",
		previmg:site_ws_path+"/resource/prevlabel.gif",
		nextimg:site_ws_path+"/resource/nextlabel.gif",
		effectimg:site_ws_path+"/resource/zzoop.gif",
		effectpos:{x:-40,y:-20},
		effectclass:'effectable',
		closeimg:site_ws_path+"/resource/close.gif",
		/*closeimg:'resource/spacer.gif',*/
		resizable:true
	});
});
