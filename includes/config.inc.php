...
define('THUMB_CACHE_DIR', 'mobile/thumb_cache');
define('PLUGINS_DIR', 'includes/plugins');
define('UP_FILES_FS_PATH', 'mobile/uploaded_files');
define('UP_FILES_WS_PATH', 'mobile/uploaded_files');
define('UPLOADED_FILE_PATH', 'mobile/uploaded_files');
